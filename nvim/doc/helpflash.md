```vim [[:help flash.nvim-flash.nvim]]
...
The nvim-treesitter
<https://github.com/nvim-treesitter/nvim-treesitter/tree/main> **main** rewrite
no longer includes incremental selection. You can use **flash.nvim** instead.
...
This will allow you to use `s` in normal mode and `<a-s>` in insert mode, to
jump to a label in the picker results.
